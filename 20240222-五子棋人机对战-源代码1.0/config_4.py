...
value_model_X_test = {
    ...
    '4': {
        ...
        '4_3_8': ('OX XXX  ', 126),
        '4_3_9': ('OX XXX ', 121),
        '4_3_4_s': ('X XXX  ', 126),  # 开头
        '4_3_5_s': ('X XXX ', 120),  # 开头
        '4_2_4': ('   XX XXO', 124),
        '4_2_20': ('OXX XX   ', 122),
        '4_2_21': ('OXX XX  ', 121),
        '4_2_22': ('OXX XX ', 120),
        '4_2_9': ('  XX XXO', 121),
        '4_2_15_s': ('XX XX   ', 124),  # 开头
        '4_2_16_s': ('XX XX  ', 120),  # 开头
        '4_2_17_s': ('XX XX ', 122),  # 开头
        '4_2_13_e': (' XX XX', 122),  # 结尾
        '4_2_8_e': ('  XX XX', 124),  # 结尾
        '4_2_14': (' XX XXO', 122),
        '4_2_3_e': ('   XX XX', 124),  # 结尾
        '4_2_9': ('  XX XXO', 124),
        '4_1_3': (' XXX XO', 126),
        '4_1_2_e': (' XXX X', 126),  # 结尾
        '4_3_3': (' X XXXO', 120),
        ...
        '4_1_7': ('OXXX XO', 100),
        '4_1_4_s': ('XXX X', 105),
        '4_1_6_e': ('OXXX X', 105),  # 结尾
        '4_3_7_s': ('X XXXO', 105),  # 开头
        '4_3_10': ('OX XXXO', 105),
        '4_2_24': ('OXX XXO', 100),
